...
//정답확인 및 오답등록
	...
	public QuizBoardPagingVo makeQuizPage(int currentPage) {
		// 게시글 총 갯수
		int totalCount = dao.selectQuizTotalCount();
	   ...
	   //CSS &&
			...
			//React
				public QuizBoardPagingVo makeReactPage(int currentPage) {
				  ...
				  //Spring
				public QuizBoardPagingVo makeSpringPage(int currentPage) {
					// 게시글 총 갯수
					int totalCount = dao.selectQuizTotalCount();
					...
					List<QuizBoardVo> SpringList = dao.selectSpringList(startRow, COUNT_PER_PAGE);

					return new QuizBoardPagingVo(SpringList, currentPage, startPage, endPage, totalPage);
				}
				
				  //Aws
				public QuizBoardPagingVo makeAwsPage(int currentPage) {
					// 게시글 총 갯수
					int totalCount = dao.selectQuizTotalCount();
					...
					List<QuizBoardVo> AwsList = dao.selectAwsList(startRow, COUNT_PER_PAGE);

					return new QuizBoardPagingVo(AwsList, currentPage, startPage, endPage, totalPage);
				}	
				
			
				
				  //오답
				public QuizBoardPagingVo makeQuizIncorrectPage(int currentPage) {
					// 게시글 총 갯수
					int totalCount = dao.selectQuizTotalCount();
