...
public interface QuizBoardMapper {
	...
	//Spring 리스트
	public List<QuizBoardVo> selectSpringList(@Param("startRow") int startRow, @Param("count") int count);
	//Aws 리스트
	public List<QuizBoardVo> selectAwsList(@Param("startRow") int startRow, @Param("count") int count);
