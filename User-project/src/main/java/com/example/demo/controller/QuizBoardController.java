...
public class QuizBoardController {
	...
	//퀴즈 삭제
	@RequestMapping("/deleteQuiz1")
	public ModelAndView delete1(int quizNum, HttpSession session) {
		String loginId = (String)session.getAttribute("loginId");
		boolean result = service2.deleteQuizIncorrectCount1(quizNum, loginId);
		ModelAndView mv = new ModelAndView();
		mv.addObject("vo", result);
		mv.setViewName("Quiz/delete_result");
		return mv;
