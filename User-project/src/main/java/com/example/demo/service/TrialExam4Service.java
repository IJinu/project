...
//정답확인 및 오답등록
	public int insertTrialAnswer(TrialIncorrectCount4Vo vo,int selectedTrialAnswer,String loginId) {
		int result = 0;
	...
	public int maxPage(TrialExam4Vo vo) {
	  ...
	  //종합문제
		...
		public TrialExamPaging4Vo makeTrialPage(int currentPage) {
		  ...
		  //오답
		public TrialExamPaging4Vo makeTrialIncorrectPage(int currentPage, String loginId) {
			// 게시글 총 갯수
			int totalCount = dao.selectTrialTotalCount();
