...
//정답확인 및 오답등록
	public int insertTrialAnswer(TrialIncorrectCount5Vo vo,int selectedTrialAnswer,String loginId) {
		int result = 0;
	...
	public int maxPage(TrialExam5Vo vo) {
	  ...
	  //종합문제
		...
		public TrialExamPaging5Vo makeTrialPage(int currentPage) {
		  ...
		  //오답
		public TrialExamPaging5Vo makeTrialIncorrectPage(int currentPage, String loginId) {
			// 게시글 총 갯수
			int totalCount = dao.selectTrialTotalCount();
